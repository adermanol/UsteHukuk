import { RulesEditor } from '@/modules/agenda'
  ...
  return (
    <div className="p-6 md:p-10 md:pl-[120px] min-h-screen text-foreground bg-transparent">
      ...
      <p className="text-muted-foreground mb-8 max-w-2xl text-lg">
        Süre hesaplayıcının kullandığı kural seti. Her kural, büro tarafından doğrulanana kadar hesaplayıcıda "doğrulanmadı" rozeti taşır.
      </p>
